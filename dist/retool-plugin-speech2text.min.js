(function () {
  ...
  var css_248z = "*{box-sizing:border-box}body,html{height:100%;margin:0;overflow:hidden;padding:0;width:100%}.style-module_speecher__ZAYi-{font-family:Inter var,Inter,-apple-system,\"system-ui\",system-ui,Segoe UI,Roboto,Helvetica Neue,Ubuntu,sans-serif}body{align-items:center;display:flex;flex-direction:column;justify-content:center;margin:0;overflow:hidden;padding:0}.style-module_button__jq3AX{background-color:#3c92dc;border:1px solid #266ebd;border-radius:4px;color:#fff;cursor:pointer;display:block;font-size:12px;font-weight:500;height:100%;padding:8px;pointer-events:all;width:100%}.style-module_button__jq3AX:hover{background-color:#3282ce;border:1px solid #1f60ae}.style-module_row__H2sPc{display:flex;height:100%;width:100%}.style-module_title__Hei5S{font-size:.9rem}.style-module_err__g8zge,.style-module_title__Hei5S{align-items:center;display:flex;flex-direction:column;justify-content:center;pointer-events:none;text-align:center;-webkit-user-select:none;-moz-user-select:none;user-select:none}.style-module_err__g8zge{background-color:hsla(0,100%,95%,.85);font-size:.8rem;height:100%;left:0;position:absolute;top:0;width:100%}.style-module_active__ssQXz{opacity:1;pointer-events:all}.style-module_inactive__gXEdI{opacity:.5;pointer-events:none}";
